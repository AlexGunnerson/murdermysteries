A different team lead within the company has reviewed the current code/implementation and provided findings above. Important context:
...
These can be found in the chat above, in the most recent output.
