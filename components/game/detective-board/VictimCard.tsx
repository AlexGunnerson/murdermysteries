        ...
        <div className="p-6 pt-10">
          ...
          <div className="space-y-3 mb-6">
            <p 
              ...
              style={{ fontFamily: "'Caveat', cursive" }}
            >
              My Husband. The Patriarch. He built this entire fortune through relentless foresight in global commodities. He was master of the estate, known for his shrewdness and the annual charity gala. What the world didn&apos;t see was the profound, quiet love we shared. I thought we had more time...
            </p>
          </div>
