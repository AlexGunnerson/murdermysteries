...
export function SceneViewer({ sceneName, images, onClose }: SceneViewerProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Scene title and counter */}
        <div className="absolute -top-12 left-0 text-white">
          <h3 className="text-2xl font-bold mb-1">{sceneName}</h3>
        ...
        <div className="relative bg-white p-4 shadow-2xl">
          <div className="relative w-full aspect-video bg-gray-100">
            <Image
              ...
              alt={`${sceneName} - Image ${currentIndex + 1}`}
              fill
