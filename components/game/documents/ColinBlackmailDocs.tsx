export const ColinBlackmailPage1 = () => (
  <div className="bg-white border border-[#333] p-8 font-serif">
    ...
    <div className="leading-relaxed text-justify space-y-4">
      ...
      <p>
        <strong>Condition:</strong> Excellent. Minor wear consistent with age. All stones secure in original settings.
      </p>

      <p><strong>Weight:</strong> Approximately 6.2 grams</p>

      <p><strong>Size:</strong> British L (American 6)</p>
    </div>
