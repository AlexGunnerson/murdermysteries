...
-- =============================================================================
-- This will set up case01 with all content (scenes, suspects, records)
-- Run this in your Supabase dashboard: SQL Editor → New Query → Paste → Run
-- =============================================================================

-- PART 1: Create Case01
...
BEGIN
    ...
    IF v_case_id IS NULL THEN
        RAISE EXCEPTION 'Case01 not found. Migration failed.';
    END IF;
    ...
    RAISE NOTICE '✓ Case01 setup complete! Inserted: 6 scenes, 5 suspects, 7 records';
END $$;

-- =============================================================================
-- DONE! Now refresh your browser with Cmd+Shift+R (Mac) or Ctrl+Shift+R
-- =============================================================================
